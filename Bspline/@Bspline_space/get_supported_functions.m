...
% get_supported_functions calcola gli indici delle b-aplines della base di 
% space che hanno supporto comune con le funzioni indicizzate in fun_ind.
%
...
%               indicate da fun_ind. Gli indici sono nella stessa forma di
%               quelli di input. 
%
% NOTE:
%   
%   1. In questo caso siccome l'operazione non può essere vettorializzata,
%   ma necessita di essere svolta una funzione per volta, uso gli indici
...
for fundx=fun_ind
    ...
    v=[1:knots_ind(1)-1];   % seleziona i nodi antecedenti alla funzione 
